...
def summarize_by_coze(content: str) -> str:
    ...
    prompt = (f'Think carefully to summarize main points of the following article delimited by triple backticks in 2 concise sentences. '
              f'Ensure that the summary does not exceed 100 characters.\n'
              f'```{content}.```')
